		...
		<div id="container">
			...
			<div id="main">
				...
				<form id="registform" class="h-adr" action="${pageContext.request.contextPath}/front/entrycheck" method="post">
					...
					<br>性<input type="text" name="firstName" value="${data.firstName}" required>&nbsp;&nbsp;&nbsp;
					...
					〒<input type="text" name="memberZipCode" class="p-postal-code" size="7" maxLength="7">&nbsp;例：1648787<br>
					
					都道府県<input type="text" name="prefectures" class="p-region" />&nbsp;例：東京都<br>
					市区町村<input type="text" name="municipality" class="p-locality"  />&nbsp;例：中野区<br>
					番地<input type="text" name="address" class="p-street-address" />&nbsp;例：東中野4-2-3<br>
					建物名<input type="text" name="buildingName" class="p-extended-address" />&nbsp;例：専門学校東京テクニカルカレッジ<br><br>
					
					電話番号<input type="text" name="memberPhoneNumber" minlength="10" maxlength="11" required>&nbsp;例：0120444906<br><br>
					...
					<div><label for="passInput">パスワード</label>&nbsp;&nbsp;例：password&nbsp;※8文字以上</div>
					<div>
