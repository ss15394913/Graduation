...
<html lang="ja">
	...
	<div align="center"><section id="buyButton"></div>
	</section>
	<section id="price">
	...
	<footer>
		...
		<input type="hidden" value="${sessionScope.cartInfo} id="cartInfo">
	</body>
	<script>
		var arr = document.getElementById("memberid").value;
		var cartInfo = document.getElementById("cartInfo").value;
		parseInt(arr);
		if(catinfo == 'cartpresence'){
			if(arr >0){
				document.getElementById("buyButton").innerHTML = "<form action=\"${pageContext.request.contextPath}/front/memberorder\" method=\"post\"><input type=\"submit\" value=\"購入する\"></form>";
			...
			document.getElementById("buyButton").innerHTML = "<p>カートに商品が存在しません</p>";
		}
	</script>
</html>
