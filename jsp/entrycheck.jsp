...
<body id="top" class="c1">
    ...
    <div id="container">
        ...
        <head>
            ...
            <center>
                <a href="${pageContext.request.contextPath}/front/entrytemp"><img src="${pageContext.request.contextPath}/images/entry.png" width="240" height="80" alt="New Menber Resist"></a>
