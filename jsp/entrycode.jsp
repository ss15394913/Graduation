...
<li class="arrow"><a href="${pageContext.request.contextPath}/productlist">SALE</a>
</li>
<li class="arrow"><a href="${pageContext.request.contextPath}/productlist">RANKING</a>
</li>
<li class="arrow"><a href="${pageContext.request.contextPath}/productlist">ALLITEM</a>
</li>
