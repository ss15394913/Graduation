		...
		<div id="container">
			...
			<div id="main">
				<form class="h-adr" action="ordercheck" method="post">
					...
					&nbsp;&nbsp;性&nbsp;<input class="name" type="text" name="firstname" required>&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;名&nbsp;<input class="name" type="text" name="name" required>&nbsp;例：山田 太郎&nbsp;<span style="color: red;">※必須</span><br><br>
					
					セイ<input class="name" type="text" name="kanafirstname" required pattern="^[ァ-ンヴー]+$">&nbsp;&nbsp;&nbsp;
					メイ<input class="name" type="text" name="kananame" required pattern="^[ァ-ンヴー]+$">&nbsp;例：ヤマダ タロウ&nbsp;<span style="color: red;">※必須</span><br><br>
					
					<span class="p-country-name" style="display:none;">Japan</span>
					〒<input type="text" id="address_0" class="p-postal-code" size="7" maxlength="7" minlength="7" name="zipcode" autocomplete="postal-code"  value="${data.addr0}">&nbsp;例：1640003&nbsp;<span style="color: red;">※必須</span><br>
					
					都道府県<input name="prefectures" type="text" id="address_1" class="p-region" autocomplete="address-level1" required />&nbsp;例：東京都&nbsp;<span style="color: red;">※必須</span><br>
					市区町村<input name="city" type="text" id="address_2" class="p-locality" autocomplete="address-level2" required />&nbsp;例：中野区&nbsp;<span style="color: red;">※必須</span><br>
					　番地　<input name="blocknumber" type="text" id="address_3" class="p-street-address" autocomplete="address-line1" required />&nbsp;例：東中野4-2-3&nbsp;<span style="color: red;">※必須</span><br>
					&nbsp;建物名&nbsp;&nbsp;<input name="bildingname" type="text" id="address_4" class="p-extended-address" autocomplete="address-line2" />&nbsp;例：専門学校東京テクニカルカレッジ<br><br>
					
					電話番号<input type="text" name="phonenumber" maxlength="11" minlength="10" pattern="^[0-9]+$" required>&nbsp;例：0120444906&nbsp;※半角数字のみ、ハイフン(-)は入れない&nbsp;<span style="color: red;">※必須</span><br><br>
